...
for y in range(len(grid)-3):
    for x in range(3, len(grid[y])):
        diags.append(grid[y][x]*grid[y+1][x-1]*grid[y+2][x-2]*grid[y+3][x-3])
...
for y in range( len(grid)):
    for x in range(len(grid[y]) - 3):
        rows.append(grid[y][x]*grid[y][x+1]*grid[y][x+2]*grid[y][x+3])

for y in range( len(grid)-3):
    for x in range(len(grid[y])):
        columns.append(grid[y][x]*grid[y+1][x]*grid[y+2][x]*grid[y+3][x])

prods = diags + rows + columns
print max(prods)